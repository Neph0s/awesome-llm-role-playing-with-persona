# LLM Role-Playing/Persona Papers
...
Awesome-llm-role-playing-with-persona: a curated list of large language models for role-playing with assigned personas.

---

*"Here are some other paper lists you might be interested in:*

💡 **[Persona Paper](https://github.com/Sahandfer/PersonaPaper):** A list of papers related to persona-based dialogue systems and personalized response generation.
